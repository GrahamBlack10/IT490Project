...
sudo ufw allow from 192.168.196.138 to 192.168.196.37 port 5672 
...
sudo ufw allow from 192.168.196.134 to 192.168.196.37 port 5672 
...
# To reset firewall: sudo ufw reset